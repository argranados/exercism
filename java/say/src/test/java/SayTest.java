...
public class SayTest {
    ...
    @Test
    public void eigth() {
        assertThat(say.say(8)).isEqualTo("eight");
    }
...
//    @Disabled
    ...
    @Test
    public void fiftyOneThousandTwoHundredThirtyFour() {
        assertThat(say.say(51_234)).isEqualTo("fifty-one thousand two hundred thirty-four");
    }

    @Test
    public void sixHundredFiftyFourThousandThreeHundredTwentyOne() {
        assertThat(say.say(654_321)).isEqualTo("six hundred fifty-four thousand three hundred twenty-one");
    }
...
//    @Disabled
    @Test
    public void twentyThreeMillionTwoThousandThreeHundredFortyFive() {
        assertThat(say.say(23_002_345)).isEqualTo("twenty-three million two thousand three hundred forty-five");
    }
...
//    @Disabled
    ...
    public void billions() {
        assertThat(say.say(90_000_000_000L)).isEqualTo("ninety billion");
    }
