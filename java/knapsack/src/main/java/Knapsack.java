...
/*
 * FIRST ITERATION: My strategy was to generate all possible combinations of items and then iterate over them
 ...
 * SECOND ITERATION: use Sets.powerSet from Guava library to generate all combinations of items.
 */
class Knapsack {
    ...
    int maximumValue(int maximumWeight, List<Item> items) {
        ...
        Set<Set<Item>> allCombinations = Sets.powerSet(new HashSet<>(items));
