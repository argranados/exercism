# Execirsm Programming Exercises

This repository contains programming exercises of different tracks like Java, Javascript, Kotlin, Python and Bash, below are instructions from [Exercism][exercism] website to install cli. This repo structure was created when I installed the cli and then I edited this README to give a description of my work.  
